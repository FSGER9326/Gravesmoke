...
requireIncludes(main, "fetch('./data/origins.json')", 'src/main.js');
requireIncludes(main, "fetch('./data/progression.json')", 'src/main.js');
requireIncludes(main, "fetch('./data/travel.json')", 'src/main.js');
requireIncludes(main, "fetch('./data/settlements.json')", 'src/main.js');
...
requireIncludes(main, 'function originScreen', 'src/main.js');
requireIncludes(main, 'function awardXp', 'src/main.js');
requireIncludes(main, 'function checkLevelUp', 'src/main.js');
requireIncludes(main, 'function learnPerk', 'src/main.js');
requireIncludes(main, 'function settlementScreen', 'src/main.js');
requireIncludes(main, 'function characterSheet', 'src/main.js');
requireIncludes(main, 'function withinSettlement', 'src/main.js');
